...
export const Sidebar = React.memo(function Sidebar({ onExit }: { onExit?: () => void }) {
  ...
  const submenuCategories = useMemo(() => [
    ...
    { 
      ...
      tools: ['tree', 'hill', 'park', 'park_large', 'tennis', 'playground_small', 'playground_large', 'community_garden', 'pond_park', 'park_gate', 'greenhouse_garden', 'mini_golf_course', 'go_kart_track', 'amphitheater', 'roller_coaster_small', 'campground', 'cabin_house', 'mountain_lodge', 'mountain_trailhead'] as Tool[]
    },
    { 
      key: 'sports', 
