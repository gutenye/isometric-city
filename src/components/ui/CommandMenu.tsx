...
function buildMenuItems(): MenuItem[] {
  ...
  // Tools category
  const toolsCategory: Tool[] = ['select', 'bulldoze', 'road', 'tunnel', 'rail', 'subway'];
  ...
  const parksCategory: Tool[] = ['tree', 'hill', 'park', 'park_large', 'tennis', 'playground_small', 'playground_large', 'community_garden', 'pond_park', 'park_gate', 'greenhouse_garden', 'mini_golf_course', 'go_kart_track', 'amphitheater', 'roller_coaster_small', 'campground', 'cabin_house', 'mountain_lodge', 'mountain_trailhead'];
